    ...
    <div style={styles.container} ref={containerRef}>
      ...
      <div style={styles.leftSection}>
        <div style={{ animation: 'slideInLeft 0.8s ease-out' }}>
          ...
          <p style={styles.brandSubtitle}>Join thousands organizing their work</p>
          <div style={styles.benefitsList}>
            ...
            <div style={styles.benefitItem}>
              <span style={styles.benefitIcon}>🚀</span>
              <span>Powerful features included</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={styles.formContainer}>
          <div style={{ animation: 'slideInRight 0.8s ease-out' }}>
            <div style={styles.formHeader}>
              ...
              <p style={styles.formSubtitle}>Start managing tasks effortlessly</p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              >
                <span
                  style={{
                    opacity: isSubmitting || loading ? 0 : 1,
                    transition: 'opacity 0.3s',
                  }}
                >
                  {loading ? 'Creating Account...' : 'Create Account'}
                </span>
                {(isSubmitting || loading) && <span style={styles.spinner}></span>}
              </button>
            </form>
            ...
            <div style={styles.loginPrompt}>
              ...
              <button onClick={onSwitchToLogin} style={styles.loginLink}>
                Sign in
              </button>
            </div>
          </div>
